...
class TeamAndSignaturesSection {
    ...
    return pw.Container(
      ...
      child: pw.Text(
        ...
        style: pw.TextStyle(
          ...
          color: PdfInstitutionalColors.black,
        ),
      ),
    );
  }
  ...
  static pw.Widget _teamTable(List<OccurrenceTeamMember> team) {
    return pw.Table(
      border: pw.TableBorder.all(color: PdfInstitutionalColors.grey300),
      columnWidths: const {
  ...
  static pw.TableRow _headerRow(List<String> labels) {
    return pw.TableRow(
      decoration: pw.BoxDecoration(color: PdfInstitutionalColors.grey100),
    ...
    return pw.Container(
      ...
      decoration: pw.BoxDecoration(
        border: pw.Border.all(
          color: PdfInstitutionalColors.amberStrong,
          width: 2,
        ),
        borderRadius: pw.BorderRadius.circular(4),
        color: PdfInstitutionalColors.amberSoft,
      ),
      child: pw.Column(
        crossAxisAlignment: pw.CrossAxisAlignment.start,
        children: [
          pw.Text(
            ...
            style: pw.TextStyle(
              fontSize: 12,
              fontWeight: pw.FontWeight.bold,
              color: PdfInstitutionalColors.amberDeep,
            ),
          ),
          pw.SizedBox(height: 8),
          pw.Text(
