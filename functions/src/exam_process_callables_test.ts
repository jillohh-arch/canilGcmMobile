...
async function runTests() {
  ...
  await group("14. CLINICALCASE DERIVED PROJECTIONS & ATOMICITY (F20.EXAM-V1)", async () => {
  ...
  await group("K6/K7. transição open->under_investigation via autoridade única, +1 exato", async () => {
    ...
    assert.strictEqual(c2["revision"], 3, "com projeção de evento => revision avança de 2 para 3");
